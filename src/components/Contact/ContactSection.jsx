...
// (stacked on mobile, info first). Wrapped in SectionWrapper for the scroll reveal.
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            ...
            <p className="mt-6 max-w-md text-base text-text-secondary sm:text-lg">
              Open to AI projects, collaborations, and smart system builds.
            </p>
            ...
            {/* Social links — inline SVGs (this lucide-react version lacks brand icons) */}
